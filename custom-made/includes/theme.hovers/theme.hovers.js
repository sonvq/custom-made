...
jQuery(document).on('action.ready', function(e) {
	...
	if (CUSTOM_MADE_STORAGE['menu_hover']=='slide_line' || CUSTOM_MADE_STORAGE['menu_hover']=='slide_box') {
		setTimeout(function() {
			"use strict";
			jQuery('#menu_main').spasticNav({
				style: CUSTOM_MADE_STORAGE['menu_hover']=='slide_line' ? 'line' : 'box',
				color: CUSTOM_MADE_STORAGE['menu_hover_color'],
				colorOverride: false
			});
		}, 500);
	}
...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
    "use strict";
	if (CUSTOM_MADE_STORAGE['button_hover'] && CUSTOM_MADE_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.custom_made_tabs .custom_made_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_'+CUSTOM_MADE_STORAGE['button_hover']);
		if (CUSTOM_MADE_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.custom_made_tabs .custom_made_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.widget_tag_cloud a:not([class*="sc_button_hover_style_"])\
				').addClass('sc_button_hover_style_alterbd');
		jQuery('.widget_product_tag_cloud a,\
				.widget_tag_cloud a\
				').addClass('sc_button_border').addClass('sc_button_hover_slide_left').removeClass('sc_button_hover_style_alterbd');
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+CUSTOM_MADE_STORAGE['button_hover']);

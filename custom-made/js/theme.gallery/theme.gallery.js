...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	...
	cont.find('.portfolio_wrap').each(function() {
		...
		if (!portfolio.hasClass('inited')) {
			...
			imagesLoaded( portfolio_dom, function() {
				// initialize masonry
				portfolio.masonry({
					itemSelector: '.post_layout_portfolio',
					columnWidth: '.post_layout_portfolio',
	...
	cont.find('.gallery_wrap:not(.inited)').each(function(idx) {
		...
		if (!CUSTOM_MADE_STORAGE['GalleryFx']) CUSTOM_MADE_STORAGE['GalleryFx'] = {};
		...
		CUSTOM_MADE_STORAGE['GalleryFx'][id] = new GalleryFx(this, {
